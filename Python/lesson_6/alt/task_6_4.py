...
def prepare_dataset(path_users_file: str, path_hobby_file: str):
    ...
    """
    tmp = {}
    with open(path_users_file, encoding='utf-8') as users_file, open(path_hobby_file, encoding='utf-8') as hobby_file, open('users_hobby.txt', 'w', encoding='utf-8') as users_hobby:
