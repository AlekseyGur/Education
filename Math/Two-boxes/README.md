...
Количество шаров в коробках непрерывно меняется. А следовательно, изменяется и вероятность получить белый. Поэтому необходимо вручную пересчитать вероятность каждого возможного исхода. Для этого сделаем таблицу всех возможных исходов, в которой "+" - это белые шары:
...
print()
print('"+" - вероятность получения белого шара')
print('"-" вероятность получения чёрного')
