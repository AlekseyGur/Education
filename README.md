...
- [Рекомендательные системы](/Recom-system)
  - [Урок 1. Введение, примеры задач, бизнес- и ML-метрики](Recom-system/lesson_1)
- [Библиотеки Python для Data Science: продолжение](master/DataScience-tools-2)
  - [Урок 1. Введение в задачу классификации. Постановка задачи и подготовка данных](/DataScience-tools-2/lesson_1)
