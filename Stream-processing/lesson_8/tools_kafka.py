...
class Kafka():
    ...
    def get(self, 
        ...
        Если установлен параметр return_rows, то возвращает результат в списке, иначе в списке
        :param name: название топика или список из названий
        ...
        :param return_rows: False - распечатать результат в консоль. True - вернуть в списке
        """
